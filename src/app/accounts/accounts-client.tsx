...
export function AccountsClient({ initialAccounts, initialContacts, initialCases, initialTasks, initialMeetings }: AccountsClientProps) {
...
function AccountsView({ initialAccounts, initialContacts, initialCases, initialTasks, initialMeetings }: Omit<AccountsClientProps, 'initialWorkflows'>) {
    ...
    const { data: contacts, isLoading: contactsLoading } = useQuery<Contact[]>({ queryKey: ['contacts'], queryFn: getContacts, initialData: initialContacts });
    const { data: cases, isLoading: casesLoading } = useQuery<Case[]>({ queryKey: ['cases'], queryFn: getCases, initialData: initialCases });
    const { data: tasks, isLoading: tasksLoading } = useQuery<Task[]>({ queryKey: ['tasks'], queryFn: getTasks, initialData: initialTasks });
...
function ContactsView({ initialAccounts, initialContacts, initialCases, initialTasks, initialMeetings }: Omit<AccountsClientProps, 'initialWorkflows'>) {
    const queryClient = useQueryClient();
    const { data: contacts, isLoading: contactsLoading } = useQuery<Contact[]>({ queryKey: ['contacts'], queryFn: getContacts, initialData: initialContacts });
    const { data: accounts, isLoading: accountsLoading } = useQuery<Account[]>({ queryKey: ['accounts'], queryFn: getAccounts, initialData: initialAccounts });
    ...
    const { data: meetings } = useQuery<Meeting[]>({ queryKey: ['meetings'], queryFn: getMeetings, initialData: initialMeetings });
